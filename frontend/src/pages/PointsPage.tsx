...
export const PointsPage: React.FC = () => {
  ...
  const handleApproveLTP = async () => {
    ...
    try {
      ...
      // 检查当前授权状态
      const currentAllowance = await pointsContract.allowance(account, CONTRACT_ADDRESSES.lottery);
      console.log('Current LTP allowance:', currentAllowance.toString());
      ...
      // 验证授权
      const newAllowance = await pointsContract.allowance(account, CONTRACT_ADDRESSES.lottery);
      console.log('New LTP allowance:', newAllowance.toString());
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-green-800">
                      Authorization ensures secure and seamless transactions
                    </span>
                  </div>
                </div>
              )}
